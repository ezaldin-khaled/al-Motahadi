            ...
            <div className="booking-right-column">
              ...
              <div className="booking-reachout">
                ...
                <div className="booking-follow-icons" aria-label={t('contact.followUs')}>
                  <a className="booking-follow-icon" href="https://www.instagram.com/almotahadi.medical.rehab" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="6"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1"/></svg></a>
                  <a className="booking-follow-icon" href="https://www.facebook.com/almotahadi.physio" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 22v-8h2.7l.4-3H13.5V9.1c0-.9.2-1.5 1.5-1.5h1.7V5c-.3 0-1.4-.1-2.7-.1-2.7 0-4.5 1.6-4.5 4.7V11H7v3h2.5v8h4Z"/></svg></a>
                  <a className="booking-follow-icon" href="https://x.com/ALMOTAHADI_MED" target="_blank" rel="noopener noreferrer" aria-label="X"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.9 2H22l-6.8 7.8L23.2 22h-6.6l-5.2-6.8L5.6 22H2.5l7.3-8.4L.8 2h6.8l4.7 6.2L18.9 2Zm-1.2 18h1.7L8.1 3.9H6.3L17.7 20Z"/></svg></a>
                  <a className="booking-follow-icon" href="https://www.linkedin.com/company/almotahadi" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M6.9 6.7a2 2 0 1 1 0-4 2 2 0 0 1 0 4ZM5.3 21.3V9h3.2v12.3H5.3Zm5.3 0V9h3.1v1.7h.1c.4-.8 1.6-1.9 3.4-1.9 3.6 0 4.3 2.3 4.3 5.3v7.2h-3.2v-6.4c0-1.5 0-3.4-2.1-3.4s-2.4 1.6-2.4 3.3v6.6h-3.2Z"/></svg></a>
                  <a className="booking-follow-icon" href="https://www.tiktok.com/@almotahadi.medical" target="_blank" rel="noopener noreferrer" aria-label="TikTok"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.73h-3.28v13.86a2.89 2.89 0 1 1-2-2.75V9.74a6.17 6.17 0 1 0 5.28 6.08V8.79a8.13 8.13 0 0 0 4.77 1.54V6.69z"/></svg></a>
                </div>
              </div>
            </div>
          </div>

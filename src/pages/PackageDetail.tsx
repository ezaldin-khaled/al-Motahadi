...
const DETAIL_CONFIG_EN: Record<DetailType, DetailConfig> = {
  individual: {
  ...
  'intensive-home-therapy': {
    ...
    packages: [
      ...
      {
        title: 'Intensive Home-Based Hant Program',
        sessions: '20 Sessions',
        description:
...
const DETAIL_CONFIG_AR: Record<DetailType, DetailConfig> = {
  individual: {
    heroTitle: 'باقات العلاج الفردي في مركز المتحدي',
    heroDesc: [
      'في مركز المتحدي للتأهيل الطبي، نقدم مجموعة من باقات العلاج الفردي المصممة لتوفير رعاية وتأهيل شخصي يناسب احتياجات كل مريض.',
      'تم إعداد هذه الباقات خصيصًا للأفراد الذين يحتاجون إلى جلسات منتظمة داخل المركز تحت الإشراف المباشر لفريقنا الطبي، مع متابعة مستمرة للتقدّم وبناء تعافٍ تدريجي وصحي طويل الأمد.',
    ],
    label: 'برامج للأفراد',
    mainTitle: 'باقاتنا الفردية',
    packages: [
      {
        title: 'باقة توكلنا',
        ...
        sessions: '5 جلسات',
        description:
          'لمن يبحث عن تأهيل قصير المدى أو برنامج علاجي محدد، توفّر باقة توكلنا 5 جلسات مركّزة مع متابعة منتظمة للتقدّم.',
        meta: 'سعر الجلسة: 20.700 ر.ع',
        sessionPrice: '20,700',
        totalPrice: '103,500',
        secondaryDescription:
          'تُعد هذه الباقة مثالية للمرضى الذين يحتاجون إلى عدد محدّد من الجلسات مع خطة علاجية مركزة وواضحة.',
      },
      {
        title: 'باقة واثق',
        subtitle: 'تقدّم مستمر',
        sessions: '10 جلسات',
        description:
          'توفر باقة واثق 10 جلسات علاجية، مناسبة لمن يبحث عن برنامج تأهيلي أكثر شمولاً مع جلسة إضافية كقيمة مضافة.',
        meta: 'سعر الجلسة: 19.550 ر.ع',
        sessionPrice: '19,550',
        totalPrice: '195,500',
        secondaryDescription:
          'تساعد هذه الباقة على تحقيق تحسّن ملحوظ عبر سلسلة جلسات متتابعة، مع متابعة دقيقة من الفريق العلاجي.',
      },
      {
        title: 'باقة تسلم',
        subtitle: 'رعاية مركزة',
        sessions: '15 جلسة',
        description:
          'باقة تسلم هي خيار متوسط المدى يوفّر 15 جلسة علاجية للمرضى الذين يحتاجون إلى استمرارية أكبر في الخطة العلاجية.',
        meta: 'سعر الجلسة: 18.400 ر.ع',
        sessionPrice: '18,400',
        totalPrice: '276,000',
        secondaryDescription:
          'تمنح هذه الباقة مرونة أكبر ومدّة علاج أطول، مناسبة لمن يسعى إلى نتائج بعيدة المدى وتعافٍ أعمق.',
      },
      {
        title: 'باقة هانئ',
        subtitle: 'برنامج ممتد',
        sessions: '20 جلسة',
        description:
          'تم تصميم باقة هانئ لمن يحتاجون إلى تأهيل أكثر كثافة، مع 20 جلسة علاجية لضمان تقدّم مستمر على مدى أطول.',
        meta: 'سعر الجلسة: 17.250 ر.ع',
        sessionPrice: '17,250',
        totalPrice: '345,000',
        secondaryDescription:
          'مناسبة للحالات المعقّدة أو المزمنة التي تحتاج إلى متابعة لصيقة وعلاج متدرّج بدعم من فريق متخصص.',
      },
      {
        title: 'باقة المتحدي',
        subtitle: 'برنامج شامل',
        sessions: '30 جلسة',
        description:
          'تُعد باقة المتحدي البرنامج الأوسع والأكثر شمولاً، حيث تقدّم 30 جلسة علاجية للحالات التي تحتاج إلى دعم تأهيلي مكثّف ومستمر.',
        meta: 'سعر الجلسة: 16.100 ر.ع',
        sessionPrice: '16,100',
        totalPrice: '483,000',
        secondaryDescription:
          'مناسبة للحالات التي تتطلب تأهيلاً طويل الأمد مع عدد كبير من الجلسات لضمان أفضل نتيجة علاجية ممكنة.',
      },
    ],
    whyTitle: 'لماذا تختار باقاتنا الفردية؟',
    reasons: [
      {
        title: 'رعاية شخصية',
        text: 'يتم تصميم كل باقة وفقًا لاحتياجات المريض، مع متابعة مستمرة للتقدّم.',
      },
      {
        title: 'إشراف مباشر',
        text: 'تُقدَّم الجلسات تحت إشراف فريقنا الطبي المتخصص لضمان أعلى مستوى من الجودة.',
      },
      {
        title: 'خطط متدرجة',
        text: 'تساعدك الباقات على تحقيق تحسّن تدريجي من خلال عدد جلسات مناسب ومرن.',
      },
      {
        title: 'خيارات متعددة',
        text: 'يمكنك اختيار الباقة الأنسب لرحلتك العلاجية، سواء كانت قصيرة أو طويلة المدى.',
      },
    ],
    ctaTitle: 'جاهز لبدء رحلتك العلاجية؟',
    ctaText:
      'اختر الباقة التي تناسب احتياجاتك وابدأ رحلة التعافي مع مركز المتحدي للتأهيل الطبي، مع فريق متخصص يرافقك في كل خطوة.',
  },
  corporate: {
    heroTitle: 'باقات التأهيل المؤسسي في مركز المتحدي',
    heroDesc: [
      'يقدّم مركز المتحدي للتأهيل الطبي باقات مؤسسية مصممة لمساندة صحة الموظفين وتحسين طاقتهم الإنتاجية.',
      'تساعد هذه البرامج في خفض الإجازات المرضية، وتحسين اللياقة البدنية، ودعم الاستمرارية المهنية ضمن إطار تعاقدي منظّم.',
    ],
    label: 'برامج الشركات',
    mainTitle: 'باقاتنا للشركات',
    packages: [
      {
        title: 'باقة توكلنا للشركات',
        sessions: '5 جلسات',
        description:
          'باقة مناسبة للمؤسسات التي ترغب في دعم موظفيها ببرنامج تأهيلي قصير المدى ومركّز.',
        meta: 'سعر الجلسة: 19.550 ر.ع',
        sessionPrice: '19,550',
        totalPrice: '97,750',
        secondaryDescription:
          'مثالية للتعامل مع مشكلات محددة أو إصابات بسيطة مع عائد واضح على صحة الموظف.',
      },
      {
        title: 'باقة واثق للشركات',
        sessions: '10 جلسات',
        description:
          'برنامج تأهيلي أوسع للشركات التي ترغب في توفير خطة علاجية متكاملة مع جلسة إضافية كقيمة مضافة.',
        meta: 'سعر الجلسة: 18.400 ر.ع',
        sessionPrice: '18,400',
        totalPrice: '184,000',
        secondaryDescription:
          'يساعد على تحسين اللياقة الوظيفية وتقليل الإصابات المرتبطة بالعمل وتعزيز استمرارية الأداء.',
      },
      {
        title: 'باقة تسلم للشركات',
        sessions: '15 جلسة',
        description:
          'خيار موسّع للمؤسسات التي تحتاج إلى خطة علاجية أعمق لموظفيها عبر عدد أكبر من الجلسات.',
        meta: 'سعر الجلسة: 17.250 ر.ع',
        sessionPrice: '17,250',
        totalPrice: '258,750',
        secondaryDescription:
          'تساهم هذه الباقة في تحسين صحة الموظفين على المدى المتوسط وتقليل مخاطر الإصابات المزمنة.',
      },
      {
        title: 'باقة هانئ للشركات',
        sessions: '20 جلسة',
        description:
          'برنامج طويل المدى للشركات ذات الاحتياج العالي للتأهيل وإعادة التأهيل لموظفيها.',
        meta: 'سعر الجلسة: 16.100 ر.ع',
        sessionPrice: '16,100',
        totalPrice: '322,000',
        secondaryDescription:
          'يدعم هذه البرنامج استمرارية الأداء ويقلّل من التغيب عن العمل على المدى البعيد.',
      },
      {
        title: 'باقة المتحدي للشركات',
        sessions: '30 جلسة',
        description:
          'أشمل برنامج مؤسسي نقدّمه، مصمم للشركات التي ترغب في توفير دعم تأهيلي عميق ومستمر لموظفيها.',
        meta: 'سعر الجلسة: 14.950 ر.ع',
        sessionPrice: '14,950',
        totalPrice: '448,500',
        secondaryDescription:
          'مناسب للمؤسسات التي تعتبر صحة موظفيها استثمارًا استراتيجيًا طويل الأمد.',
      },
    ],
    whyTitle: 'لماذا تختار برامجنا المؤسسية؟',
    reasons: [
      {
        title: 'تحسين صحة الموظفين',
        text: 'تعزيز اللياقة والقدرة البدنية مما ينعكس مباشرة على جودة العمل.',
      },
      {
        title: 'تقليل الغياب المرضي',
        text: 'يساهم التأهيل المنتظم في خفض الإصابات والأمراض المرتبطة بالوظيفة.',
      },
      {
        title: 'استمرارية الأداء',
        text: 'تساعد الباقات على الحفاظ على مستوى عالٍ من الأداء على المدى الطويل.',
      },
      {
        title: 'رعاية مهنية',
        text: 'يُقدَّم العلاج بإشراف فريق متخصص في التأهيل الطبي والوظيفي.',
      },
    ],
    ctaTitle: 'استثمر في صحة فريقك اليوم',
    ctaText:
      'الاستثمار في صحة الموظفين هو استثمار في نجاح المؤسسة. تواصل معنا لاختيار الباقة الأنسب لشركتك.',
  },
  'community-care': {
    heroTitle: 'باقات برنامج الرعاية المجتمعية في مركز المتحدي',
    heroDesc: [
      'نلتزم في مركز المتحدي للتأهيل الطبي بتقديم خدمات تأهيلية شاملة وميسّرة لفئات محددة من المجتمع.',
      'تستهدف هذه البرامج كبار السن والنساء وذوي الإعاقة وذوي الدخل المحدود، مع الحفاظ على نفس معايير الجودة المهنية المعتمدة في المركز.',
    ],
    label: 'الرعاية المجتمعية',
    mainTitle: 'باقات برنامج الرعاية المجتمعية',
    packages: [
      {
        title: 'باقة الإحسان – لكبار السن',
        sessions: '15 جلسة',
        description:
          'برنامج متكامل يركّز على تحسين التوازن والحركة والاستقلالية اليومية لكبار السن.',
        meta: 'سعر الجلسة: 17.250 ر.ع',
        sessionPrice: '17,250',
        totalPrice: '258,750',
        secondaryDescription:
          'يساعد البرنامج على الحفاظ على نمط حياة نشط وآمن مع تقليل مخاطر السقوط والإصابات.',
      },
      {
        title: 'باقة الرعاية – برنامج متخصص للنساء',
        sessions: '10 جلسات',
        description:
          'برنامج تأهيلي للنساء يركّز على التأهيل قبل وبعد الولادة، واضطرابات قاع الحوض، وآلام الحوض وأسفل الظهر المرتبطة بالتغيرات الهرمونية.',
        meta: 'سعر الجلسة: 16.100 ر.ع',
        sessionPrice: '16,100',
        totalPrice: '161,000',
        secondaryDescription:
          'مصمم لدعم صحة المرأة في مراحل مختلفة مع خطة علاجية قائمة على أحدث البروتوكولات.',
      },
      {
        title: 'باقة خطوة – للأشخاص ذوي الإعاقة',
        sessions: 'وفق التقييم',
        description:
          'برنامج يقدّم خدمات تأهيلية متخصصة للأشخاص ذوي الإعاقة، مع الحفاظ على جودة عالية وتكلفة أقل من الباقات التقليدية.',
        meta: 'السعر الأصلي للجلسة: 23 ر.ع | السعر بعد الخصم (40٪): 13.800 ر.ع',
        secondaryDescription:
          'يركّز البرنامج على الاستمرارية والقدرة على تحمّل التكلفة، لضمان حصول المستفيدين على العلاج اللازم.',
      },
      {
        title: 'باقة الأمل – لذوي الدخل المحدود',
        sessions: 'وفق التقييم الاجتماعي',
        description:
          'يستهدف هذا البرنامج الأفراد الذين يواجهون ظروفًا مالية صعبة، مع إمكانية الحصول على خصم يصل إلى 70٪ بعد دراسة الحالة.',
        sessionPrice: '—',
        totalPrice: 'يُحدَّد بناءً على التقييم',
        secondaryDescription:
          'يتم تقديم الدعم وفق معايير اجتماعية واضحة لضمان وصول الخدمة لمن هم في أمسّ الحاجة إليها.',
      },
    ],
    whyTitle: 'لماذا تختار برامج الرعاية المجتمعية؟',
    reasons: [
      {
        title: 'شمولية الفئات',
        text: 'مصممة خصيصًا لمن يحتاجون إلى رعاية خاصة بسبب العمر أو الوضع الصحي أو المادي.',
      },
      {
        title: 'أسعار مخفضة',
        text: 'نقدّم خصومات مدروسة لتسهيل الوصول إلى خدمات التأهيل دون الإخلال بجودة الرعاية.',
      },
      {
        title: 'معايير مهنية ثابتة',
        text: 'رغم طابعها المجتمعي، تلتزم البرامج بأعلى معايير الجودة المعتمدة في المركز.',
      },
      {
        title: 'مسؤولية مجتمعية',
        text: 'نعتبر هذه البرامج جزءًا أساسيًا من رسالتنا في خدمة المجتمع.',
      },
    ],
    ...
    additionalItems: [
      {
        ...
        text: 'جميع الأسعار المذكورة لا تشمل ضريبة القيمة المضافة، حيث تُضاف نسبة 5٪ إلى السعر النهائي.',
      },
      {
        title: 'رعاية مخصّصة',
        text: 'يتم تصميم كل برنامج بما يتناسب مع ظروف وحالة كل مستفيد.',
      },
      {
        title: 'دعم مستمر',
        text: 'نوفّر متابعة دورية لضمان استمرار التحسّن وتحقيق الأهداف العلاجية.',
      },
      {
        title: 'التزام بالرسالة',
        text: 'نطوّر هذه البرامج باستمرار لتلبية احتياجات المجتمع بشكل أفضل.',
      },
    ],
    ctaTitle: 'ابدأ رحلتك مع برنامج الرعاية المجتمعية',
    ctaText:
      'نحن هنا لضمان حصول كل فرد على فرصة للعلاج والتأهيل بما يتناسب مع ظروفه. تواصل معنا لمعرفة المزيد أو لحجز استشارة.',
  },
  'home-therapy': {
    heroTitle: 'باقات العلاج المنزلي في مركز المتحدي',
    heroDesc: [
      'ندرك في مركز المتحدي أن بعض المرضى قد يواجهون صعوبة في الحضور إلى المركز بشكل منتظم بسبب الحركة أو البعد أو ظروف أخرى.',
      'لذلك نقدّم باقات العلاج المنزلي كحل مرن ومريح يقدّم نفس جودة العلاج داخل المركز ولكن في منزلك.',
    ],
    label: 'العلاج المنزلي',
    mainTitle: 'باقاتنا للعلاج المنزلي',
    packages: [
      {
        title: 'العلاج المنزلي (5 جلسات)',
        sessions: '5 جلسات',
        description:
          'خيار قصير المدى لمن يحتاج إلى دعم تأهيلي مركّز في المنزل خلال فترة محدودة.',
        meta: 'سعر الجلسة: 30.700 ر.ع',
        sessionPrice: '30,700',
        totalPrice: '153,500',
        secondaryDescription:
          'مثالي للحالات التي تحتاج إلى عدد محدود من الجلسات مع سهولة الوصول في المنزل.',
      },
      {
        title: 'العلاج المنزلي (10 جلسات)',
        sessions: '10 جلسات',
        description:
          'برنامج منزلي أشمل مع 10 جلسات لضمان تقدّم واضح في مسار التعافي.',
        meta: 'سعر الجلسة: 28.550 ر.ع',
        sessionPrice: '28,550',
        totalPrice: '285,500',
        secondaryDescription:
          'مناسب للمرضى الذين يحتاجون إلى دعم متواصل لفترة أطول داخل المنزل.',
      },
      {
        title: 'العلاج المنزلي (15 جلسة)',
        sessions: '15 جلسة',
        description:
          'خيار للحالات التي تحتاج إلى تأهيل منزلي أكثر كثافة واستمرارية.',
        meta: 'سعر الجلسة: 26.400 ر.ع',
        sessionPrice: '26,400',
        totalPrice: '396,000',
        secondaryDescription:
          'مناسب للحالات المعقّدة التي تحتاج إلى متابعة طويلة الأمد مع المعالج في المنزل.',
      },
      {
        title: 'العلاج المنزلي (20 جلسة)',
        sessions: '20 جلسة',
        description:
          'برنامج ممتد يوفّر 20 جلسة علاجية في المنزل مع متابعة دقيقة للتقدّم.',
        meta: 'سعر الجلسة: 24.250 ر.ع',
        sessionPrice: '24,250',
        totalPrice: '485,000',
        secondaryDescription:
          'خيار مثالي لمن يحتاج إلى رعاية تأهيلية طويلة المدى في بيئة المنزل.',
      },
      {
        title: 'العلاج المنزلي (30 جلسة)',
        sessions: '30 جلسة',
        description:
          'أشمل برامجنا المنزلية، يقدّم 30 جلسة علاجية لدعم التأهيل طويل الأمد.',
        meta: 'سعر الجلسة: 22.100 ر.ع',
        sessionPrice: '22,100',
        totalPrice: '663,000',
        secondaryDescription:
          'مصمم للحالات التي تحتاج إلى برنامج تأهيلي مكثّف ومستمر داخل المنزل.',
      },
    ],
    whyTitle: 'لماذا تختار باقات العلاج المنزلي؟',
    reasons: [
      {
        title: 'راحة أكبر',
        text: 'تحصل على العلاج المهني دون الحاجة لمغادرة المنزل.',
      },
      {
        title: 'خطة مخصّصة',
        text: 'تصميم الجلسات وفق حالتك الصحية وبيئتك المنزلية.',
      },
      {
        title: 'متابعة مستمرة',
        text: 'متابعة تقدّمك وتعديل الخطة عند الحاجة.',
      },
      {
        title: 'جودة مركزية في المنزل',
        text: 'نقل نفس جودة العلاج داخل المركز إلى منزلك.',
      },
    ],
    ctaTitle: 'ابدأ رحلتك مع العلاج المنزلي',
    ctaText:
      'اختر الباقة الأنسب لك، ودع فريقنا المتخصص يقدّم لك العلاج من راحة منزلك.',
  },
  'intensive-home-therapy': {
    heroTitle: 'باقات العلاج المنزلي المكثف في مركز المتحدي',
    heroDesc: [
      'بعض الحالات مثل الإصابات الشديدة أو ما بعد الجراحة أو بعض الاضطرابات العصبية تحتاج إلى علاج أكثر كثافة وامتدادًا.',
      'تقدّم باقات العلاج المنزلي المكثف مستوى أعلى من الرعاية العلاجية بجلسات أطول وأكثر تركيزًا داخل المنزل.',
    ],
    label: 'رعاية مكثفة',
    mainTitle: 'باقات العلاج المنزلي المكثف',
    packages: [
      {
        title: 'برنامج توكلنا المنزلي المكثف',
        sessions: '5 جلسات',
        description:
          'خيار علاجي قصير المدى لكن مكثف للحالات المتقدمة التي تحتاج إلى تدخل عاجل ومركّز.',
        sessionPrice: '51,400',
        totalPrice: '257,000',
        secondaryDescription:
          'مناسب لمن يحتاج إلى تحفيز سريع للتعافي في فترة زمنية قصيرة.',
      },
      {
        title: 'برنامج واثق المنزلي المكثف',
        sessions: '10 جلسات',
        description:
          'خيار أشمل لمن يحتاج إلى برنامج منزلي مكثف على مدى أطول لتحسين الوظيفة الحركية والتعافي.',
        sessionPrice: '48,100',
        totalPrice: '481,000',
        secondaryDescription:
          'مثالي للحالات التي تتطلب علاجًا مركزًا ومتكررًا للوصول إلى تعافٍ ثابت ومتدرّج.',
      },
      {
        title: 'برنامج تسلم المنزلي المكثف',
        sessions: '15 جلسة',
        description:
          'خيار قوي للحالات التي تحتاج إلى رعاية تأهيلية مكثفة وطويلة المدى، مثل ما بعد العمليات أو بعض الحالات العصبية.',
        sessionPrice: '44,800',
        totalPrice: '672,000',
        secondaryDescription:
          'يُركّز على استعادة الحركة والاستقلالية عبر برنامج منتظم ومكثف.',
      },
      {
        title: 'برنامج هانئ المنزلي المكثف',
        sessions: '20 جلسة',
        description:
          'برنامج موسّع للحالات التي تتطلب عددًا كبيرًا من الجلسات المكثفة مع متابعة لصيقة.',
        sessionPrice: '41,500',
        totalPrice: '830,000',
        secondaryDescription:
          'مناسب للحالات المعقدة التي تحتاج إلى خطّة علاجية دقيقة على مدى أطول.',
      },
      {
        title: 'برنامج المتحدي المنزلي المكثف',
        sessions: '30 جلسة',
        description:
          'أشمل برامج العلاج المنزلي المكثف، مخصص لمن يحتاج إلى رعاية طويلة الأمد داخل المنزل.',
        sessionPrice: '38,200',
        totalPrice: '1,146,000',
        secondaryDescription:
          'يدعم هذا البرنامج استعادة القوة والحركة وجودة الحياة بعد الحالات الطبية المعقدة.',
      },
    ],
    whyTitle: 'لماذا تختار باقات العلاج المنزلي المكثف؟',
    reasons: [
      {
        title: 'تأهيل متقدّم',
        text: 'مصممة للحالات الشديدة التي تحتاج إلى مستوى أعلى من كثافة العلاج.',
      },
      {
        title: 'راحة المنزل',
        text: 'تحصل على علاج مكثف دون الحاجة للتنقل إلى المركز.',
      },
      {
        title: 'رعاية شاملة',
        text: 'برامج طويلة المدى مع خطط علاجية مخصّصة وتقنيات متقدمة.',
      },
      {
        title: 'متابعة دقيقة',
        text: 'تقييم دوري للتقدّم وتعديل الخطة بما يناسب استجابتك.',
      },
    ],
    ctaTitle: 'ابدأ رحلة العلاج المنزلي المكثف',
    ctaText:
  ...
  'comprehensive-home-rehab': {
    ...
    label: 'برنامج طويل الأمد',
    mainTitle: 'منهجية العلاج',
    packages: [
      {
        title: 'الخيار الأول: نظام منتظم',
        sessions: 'حوالي 20 جلسة شهريًا',
        description:
          'خيار مناسب لمن يحتاجون إلى علاج منتظم ومعتدل مع أيام راحة كافية لمنع الإرهاق الجسدي والذهني.',
        meta: 'النمط: يومان متتاليان من العلاج يليهما يوم راحة. جلسة واحدة لمدة 90 دقيقة في كل يوم علاج.',
        secondaryDescription:
          'تركّز الجلسات على تحسين التوازن والمشي وتقليل التصلّب الحركي وتحسين القدرة الوظيفية. التكلفة الشهرية: 1,150 ر.ع (الإجمالي لثلاثة أشهر: 3,450 ر.ع).',
      },
      {
        title: 'الخيار الثاني: نظام مكثف',
        sessions: 'حوالي 40 وحدة علاجية شهريًا',
        description:
          'يُوصى به للحالات التي تحتاج إلى كثافة علاجية أعلى خاصة في المراحل الأولى من البرنامج، مع جلسات صباحية ومسائية.',
        meta: 'النمط: يومان متتاليان من العلاج يليهما يوم راحة. جلسة صباحية لمدة 90 دقيقة وجلسة مسائية لمدة 60 دقيقة في يوم العلاج.',
        secondaryDescription:
          'يركّز البرنامج على تحفيز الجهاز العصبي بالحركة المتكررة وتسريع الاستجابة للعلاج وتحسين الأداء الوظيفي. التكلفة الشهرية: 1,450 ر.ع (الإجمالي لثلاثة أشهر: 4,350 ر.ع).',
      },
    ],
    additionalTitle: 'تفاصيل البرنامج',
    additionalItems: [
      {
        title: 'المدة والتنظيم',
        text: 'يمتد البرنامج لثلاثة أشهر مع تخصيص أخصائي لكل حالة، باستخدام أجهزة علاجية محمولة.',
      },
      {
        title: 'تقييم شامل',
        text: 'يتم إجراء تقييم سريري في البداية لتحديد مستوى الشدة والتحمّل والاستجابة الحركية، وبناء الخطة وفقًا لذلك.',
      },
      {
        title: 'الشروط المالية',
        text: 'يتطلّب البرنامج دفعة أولى قدرها 1,500 ر.ع تُحتسب من إجمالي تكلفة البرنامج، مع توزيع المتبقي على دفعات شهرية.',
      },
      {
        title: 'مرونة الانتقال',
        text: 'يمكن البدء بالنظام المكثف في المرحلة الأولى ثم التحوّل إلى النظام المنتظم وفقًا للاستجابة والتحمّل.',
      },
    ],
    whyTitle: 'أهداف البرنامج',
    reasons: [
      {
        title: 'تحسين الحركة',
        text: 'العمل على تحسين الحركة وتقليل التصلّب من خلال جلسات منظمة.',
      },
      {
        title: 'إبطاء تقدّم المرض',
        text: 'يهدف البرنامج إلى الحد من تدهور الحالة العصبية وتحسين الاستقلالية الوظيفية.',
      },
      {
        title: 'تعزيز الاستقلالية',
        text: 'رفع القدرة على أداء الأنشطة اليومية واستعادة أكبر قدر ممكن من الاستقلالية.',
      },
      {
        title: 'دعم الأسرة ومقدمي الرعاية',
        text: 'تدريب أفراد الأسرة ومقدمي الرعاية على الأساليب الآمنة لدعم رحلة التأهيل.',
      },
    ],
    secondaryWhyTitle: 'لماذا تختار برنامج التأهيل المنزلي الشامل؟',
    secondaryReasons: [
      {
        title: 'رعاية مخصّصة',
        text: 'تصميم الجلسات وفق حالتك الصحية وبيئتك المنزلية وأهدافك.',
      },
      {
        title: 'راحة المنزل',
        text: 'الحصول على علاج عالي الجودة من راحة منزلك.',
      },
      {
        title: 'فريق متخصص',
        text: 'معالجون ذوو خبرة في التأهيل العصبي والحالات المعقّدة يرافقونك في كل مرحلة.',
      },
      {
        title: 'متابعة مستمرة',
        text: 'تقييمات دورية لضمان تكيّف الخطة العلاجية مع تحسّنك.',
      },
    ],
    ctaTitle: 'ابدأ رحلتك مع البرنامج المنزلي الشامل اليوم',
    ctaText:
      'نلتزم في مركز المتحدي بمساعدتك على تحسين الحركة وجودة الحياة. تواصل معنا لمعرفة المزيد أو لبدء خطتك العلاجية.',
  },
};
...
export default function PackageDetail() {
  ...
  useEffect(() => {
    if (!type || !(type in DETAIL_CONFIG_EN)) {
  ...
  const config = (i18n.language === 'ar' ? DETAIL_CONFIG_AR : DETAIL_CONFIG_EN)[type];
